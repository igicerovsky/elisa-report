...
def test_fit_reference():
    ...
    e0 = np.array([0.024639739977099576, 0.8758817990197846,
                  123757366016010.23, 3278.555705605853])
    e1 = np.array([[0.001362946571509995, 0.004811422054020865, -1397312652675520.8, -32271.26458007298],
                   [0.004811422054020865, 0.03321247562158081, -
                    1.3469057646421174e+16, -311435.8011114633],
                   [-1397312652675520.8, -1.3469057646421174e+16,
                    6.376419686260148e+33, 1.4750194830685844e+23],
